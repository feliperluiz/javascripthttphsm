...
const ConformanceClause = {
 ...
 const BlockCipherMode = {
  ...
  const BatchErrorContinuationOption = {
    CONTINUE  : 0x00000001,
    STOP      : 0x00000002,
    UNDO      : 0x00000003
}
